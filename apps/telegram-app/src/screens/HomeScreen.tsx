...
export function HomeScreen() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh",
      ...
      {/* Запас сверху здесь свой: на других экранах его держит шапка, а тут её
          нет — в полном экране знак магазина заезжал бы под часы и под кнопку
          «Закрыть» клиента. */}
      <div style={{ flex: 1, minHeight: 0, overflowY: "auto",
        padding: "calc(var(--sp-7) + var(--safe-top)) var(--gutter) var(--sp-6)" }}>
