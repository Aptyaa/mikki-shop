...
export function ProductScreen({ slug }: { slug: string }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh",
      ...
      {/* Заголовка в шапке нет намеренно: длинное название категории
          («Верхняя одежда») в узкой полосе рядом с кнопками читается плохо, а
          над заголовком товара — ровно там, где его ищут глазами. Раньше
          причина была ещё и в маскоте по центру полосы, но его из шапки
          убрали. */}
      <ScreenBar
        onBack={goBack}
        right={
